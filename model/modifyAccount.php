...
if ($_GET['page'] == '1')
{
    ...
    {
     	$_SESSION['field'] = "1";
    	$_SESSION['error'] = "* Обязательные поля";
    }
     	...
     	if ($_GET['login'] != $profile['login'])
     	{
            ...
            else 
            {
                ...
                else 
                {
                    ...
                    $_SESSION['error'] = "Имя пользователя изменено.";
            ...
            if (ft_mail_exist($_GET['mail']))
            {
                ...
                else 
                {
                    ...
                    if (isset($_SESSION['error']))
                        $_SESSION['error'] = "Имя пользователя и адрес электронной почты изменены.";
                    else
                        $_SESSION['error'] = "Адрес электронной почты изменен.";
                }
            }
     	}
    }
...
if ($_GET['page'] == '3')
{
    ...
    {
        $_SESSION['error'] = "Изменения не были выполнены";      
    }
    $data = 3;
}
