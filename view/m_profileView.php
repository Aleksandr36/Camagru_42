<?php ob_start(); ?>
	<table>
		...
		<tr>
			...
			<label for="fileToUpload" >изменить фотографию профиля</label>
			<input style="display: none" type="file" name="fileToUpload" id="fileToUpload" accept="image/*" onchange="fileName()">
			<span id="file_name"></span>
			</br>
    		<input type="submit" style="width:140px" value="Подтвердить" name="Изменить">
			</form>	
			</td>
		</tr>
		<tr><td><br/></td></tr>
