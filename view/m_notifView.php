<?php ob_start(); ?>
	<table>
		...
		<tr>
			<td id="col1"></td>
			<td><b>Новый комментарий</b></textarea></td>
		</tr>
		<tr>
			<td id="col1"><input class="input" type="checkbox" name="notif_cmt" value="1" id="notif_cmt"></td>
			<td>Получите уведомление по электронной почте</textarea></td>
		</tr>
		<tr><td><br/></td></tr>
		<tr>
			<td id="col1"></td>
			<td><b>Новый лайк</b></textarea></td>
		</tr>
		<tr>
		...
		<tr>
			<td id="col1"></td>
			<td><input type="submit" name="submit" id="submit_form" value="Подтвердить" onclick="modify_notification()"> </td>
		</tr>
	</table>
<script>
