...
<html>
	...
	<body>
					...
					<div class="modal-body">
						...
						<table id ="modal_info">
							...
							<tr>
      						...
      						<tr>
      							<td colspan="3"><input type="text" id="new_com" name="comment" placeholder="Добавить комментарий ..."></td>
							</tr>
							<tr>
								<td><input style="opacity:0" type="submit" name="submit" id="submit" onclick="<?php if (isset($_SESSION['login'])) echo "comment()"; else echo "notLog()";?>" value="Подтвердить"></td>
							</tr>
						</table>
					</div>
				</div>
		...
		<footer>
			<h4>Camagru 2020 anjada ake (Рыков Александр)</h4>
		</footer>
	</body>
</html>
