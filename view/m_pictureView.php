...
<?php
	...
	if ($i == 0)
	{
		echo "<p style='color:red'>Вы еще не сделали ни одной фотографии</p>";
	}
	else 
	{
		echo "</br><input onclick='modify_picture()' style='margin-left:60px; width:150px;' type='submit' name='submit' id='submit_form' value='Удалить'>";
	}
	$picture->closeCursor();
?>
