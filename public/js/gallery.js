function callback_gallery(data){
    ...
    if (data[0]  ==  "profile")
    {
        ...
        count_picture.innerHTML = "<b>"+data[2].picture+"</b> Публикации</td>";
        count_like.innerHTML = "<b>"+data[2].like+"</b> Нравится</td>";
        count_com.innerHTML = "<b>"+data[2].comment+"</b> Комментарии</td>";
    }
